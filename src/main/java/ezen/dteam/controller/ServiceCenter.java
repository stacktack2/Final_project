...
public class ServiceCenter {
	...
	//1.ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ - ÔøΩÔøΩÔøΩÔøΩ
	...
	//2.ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ- ÔøΩÔøΩÔøΩÔøΩ
	...
	//ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ- ÔøΩÔøΩÔøΩÔøΩ- ÔøΩ€ºÔøΩ
	...
	public String inquiryWriteOk(Authentication authentication, HttpServletResponse response, String btitle, String bcontent) throws IOException {
		...
		if(result>0) {
			response.getWriter().append("<script>alert('πÆ¿«∏¶ ¿€º∫«ﬂΩ¿¥œ¥Ÿ.');location.href='inquiryList';</script>");
		}else {
			response.getWriter().append("<script>alert('πÆ¿«∞° ¿€º∫µ«¡ˆ æ æ“Ω¿¥œ¥Ÿ.');location.href='inquiryList';</script>");			
		}
